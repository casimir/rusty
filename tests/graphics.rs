...
fn color_add() {
    assert_eq!(
        "#112244".parse::<Color>().unwrap() + "#112244".parse::<Color>().unwrap(),
        "#224488".parse::<Color>().unwrap()
    );
    assert_eq!(
        "#FFFF00".parse::<Color>().unwrap() + "#00FF80".parse::<Color>().unwrap(),
...
fn color_mult() {
    assert_eq!(
        "#222222".parse::<Color>().unwrap() * 0.5,
        "#111111".parse::<Color>().unwrap()
    );
    assert_eq!(
        "#222222".parse::<Color>().unwrap() * 1.0,
        "#222222".parse::<Color>().unwrap()
    );
    assert_eq!(
        "#222222".parse::<Color>().unwrap() * 2.0,
        "#444444".parse::<Color>().unwrap()
    );

    assert_eq!(
        "#222222".parse::<Color>().unwrap() * "#00FF80".parse::<Color>().unwrap(),
